...
var ProductsService = /** @class */ (function () {
    ...
    ProductsService.prototype.findAll = function (queryDto) {
        return __awaiter(this, void 0, void 0, function () {
            var page, limit, search, sortBy, sortOrder, skip, query, total, products;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        page = queryDto.page, limit = queryDto.limit, search = queryDto.search, sortBy = queryDto.sortBy, sortOrder = queryDto.sortOrder;
                        skip = (page - 1) * limit;
                        ...
                        return [4 /*yield*/, this.productModel.countDocuments(query.getQuery())];
                    case 1:
                        total = _b.sent();
